...
Scout 0.7.0. The advisory layer adds four tools. Two additional optional unsigned preparation tools are described in [the preparation contract](../ZERION-PREPARATION.md). The package adds no signer for the observed wallet or trade executor.
