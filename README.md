...
> **Scout 0.6.0:** Reads Arc wallets through the Zerion API and tightens x402 payment checks. Unsigned Zerion CLI preparation does not support Arc yet. See [release downloads](https://github.com/gabchess/scout-onchain/releases/tag/v0.6.0) and [claim status](CLAIMS.md).
...
<p align="center">
  <a href="CLAIMS.md"><img alt="version 0.6.0" src="https://img.shields.io/badge/version-0.6.0-0B57D0" /></a>
...
Market indicators and DCA windows use bundled synthetic price history in 0.6.0. Scout labels that source and keeps confidence low.
